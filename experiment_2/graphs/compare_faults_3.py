...
def process_and_plot(csv1, pid1, csv2, pid2, csv3, pid3, output_img="fault_comparison_3way.png"):
    # 1. Load CSVs
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Compare UVM page faults across 3 CSV files into a static PNG.")
    ...
    parser.add_argument("--out", type=str, default="fault_comparison_3way.png", help="Output PNG file name")
